...
function sumArray(sumArr) { //eslint-disable-line
    var sum1 = parseInt(sum(testArray[0], testArray [1]));
    var sum2 = parseInt(sum(sum1,testArray [2]));  
...
function multiplyArray(multArr) { //eslint-disable-line
    var mult1 = parseInt(multiply(multArr[0],multArr[1]));
    var mult2 = parseInt(multiply(mult1, multArr [2]));
    var message = 'The numbers 2,3,4 have a product of ' + mult2 + '.';
